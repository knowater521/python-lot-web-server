...
class ReedSwitch(object):
    ...
    def __init__(self, reedSwitchPin, relayLeft, relayRight, initDirection="left"):
        ...
        # 放在初始化时注册 GPIO.remove_event_detect(self.reedSwitchPin)
        # GPIO.add_event_detect(reedSwitchPin, GPIO.BOTH, callback=lambda callback: self.setStatus(callback) , bouncetime=200)
